"""SQLAlchemy ORM models for Agent Dashboard.

Defines Host, Agent, and Log tables with their relationships.
"""
...
class Host(Base):
    ...
    @property
    def projects(self):
        """Returns the cached project list JSON."""
...
class Agent(Base):
    ...
    @property
    def telemetry(self):
        """Returns the agent's telemetry dict, defaulting to empty."""
